"""
Program:    Mamaka Bowls Ordering System
Developer:  Code Runners
Date:       4/16/2025
Purpose:    The application will compute the costs of orders for products at Mamaka Bowls.
"""
...
class MamakaBowlsApp(tk.Tk):
    def __init__(self):
        ...
        self.menu_items = {
            "Bowls": [
                {"name": "Small Bowl", "price": 9.50},
                {"name": "Regular Bowl", "price": 11.00},
            ],
            "Add-ons": [
    ...
    def show_menu(self, category):
        ...
        Args:
            category (str): The category to display the menu for (e.g., "Bowls").
        """
        self.clear_frame()
        ...
        for item in self.menu_items[category]:
            ...
            add_to_cart_button = ttk.Button(item_frame, text="Add to Cart",
                                             command=lambda selected_item=item: self.show_add_ons(selected_item),
                                             style="TButton")
    ...
    def add_to_cart(self, selected_item):
        ...
        total_price = selected_item["price"] + len(selected_addons) * 0.50
        ...
        messagebox.showinfo("Added to Cart", f"{selected_item['name']} with selected add-ons has been added to your cart.")
        self.create_home_page()
